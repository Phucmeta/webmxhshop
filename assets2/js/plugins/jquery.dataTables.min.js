...
!function(n) {
        ...
        for (var e, n, a, r, o, i = t.aoColumns, l = !1, s = 0, u = t.aoData.length; s < u; s++)
            if (!(o = t.aoData[s])._aFilterData) {
                ...
                n = i.length; e < n; e++)
                    ...
                    r.indexOf && -1 !== r.indexOf("&") && (Mt.innerHTML = r,
    ...
    function ae(t, e) {
        return t ? (e = (t = P("<div/>").css("width", k(t)).appendTo(e || v.body))[0].offsetWidth,
        t.remove(),
        e) : 0
    }
    function re(t, e) {
    ...
    function Me(t, e, n, a) {
        return 0 === t || t && "-" !== t ? ((t = e ? G(t, e) : t).replace && (n && (t = t.replace(n, "")),
        a && (t = t.replace(a, ""))),
        +t) : -1 / 0
    }
    function ke(n) {
