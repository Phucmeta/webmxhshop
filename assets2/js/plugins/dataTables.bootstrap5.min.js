...
!function(t) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function(e) {
        ...
        return e = e || window,
        (a = a || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net")(e, a),
        t(a, 0, e.document)
    }
        ...
        function u(e, a) {
            for (var t, n, r = function(e) {
                ...
                Array.isArray(n))
                    ...
                    i.oApi._fnBindAction(t, {
                        action: n
                    }, r))
                }
        }
        var p, f, t, b = new o.Api(i), g = i.oClasses, m = i.oLanguage.oPaginate, w = i.oLanguage.oAria.paginate || {}, e = x(e);
        try {
